    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionCategory_CategoryID", x => x.CategoryID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    QnID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CategoryID = table.Column<int>(nullable: false, defaultValueSql: "((1))"),
                    Qn = table.Column<string>(unicode: false, maxLength: 500, nullable: true),
                    ImageName = table.Column<string>(unicode: false, maxLength: 100, nullable: true),
